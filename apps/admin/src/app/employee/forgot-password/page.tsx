...
import { EmployeeForgotPasswordForm } from "@/components/employee-app/forgot-password-form";
    ...
    <div className="relative flex min-h-screen items-center justify-center px-4 py-10">
      ...
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-ink-muted">گۆڕینی وشەی نهێنی کارمەند</p>
        </div>
        <div className="panel p-6">
          <h2 className="mb-6 text-xl font-semibold">{ckb.forgotPassword}</h2>
